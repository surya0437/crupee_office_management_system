    ...
    <ul class="list-unstyled components side-nav">
        <li>
            ...
            <ul class="collapse list-unstyled" id="mySubmenu">
                <li>
                    <a href="<?php echo system_url; ?>view/profile.php">My Profile</a>
                </li>
                <li>
                ...
                <li>
                    <a href="<?php echo system_url; ?>view/view-job.php">My Job Description</a>
                </li>
                <li>
                    <a href="<?php echo system_url; ?>view/my-attendance.php">My Attendance</a>
                </li>
                <li>
                    <a href="<?php echo system_url; ?>view/my-leave.php">My Leaves</a>
                </li>
                <li>
                    <a href="<?php echo system_url; ?>view/apply-resignation.php">My Resignation</a>
                </li>
                <li>
                    <a href="<?php echo system_url; ?>view/my_holiday.php">My Holidays</a>
                </li>
                <li>
                    <a href="<?php echo system_url; ?>view/my-salary.php">My Salary Slips</a>
                </li>
            </ul>
        </li>
        <?php
        ...
        while ($rowList = mysqli_fetch_array($sql_person)) {
            //--$arrVal = $rowList;
            $type = $rowList['user_type'];
        }
        if ($type == 'admin') {
            echo '
            <li>
                    <a href="' . system_url . 'view/list_leave.php">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a href="' . system_url . 'view/list-salary-emp.php"> Employee Lists</a>
                        </li>
                        <li>
                            <a href="' . system_url . 'view/list_salary.php"> Salary Lists</a>
                        </li>                        
                    </ul>
                </li>
                <li>
                    <a href="' . system_url . 'view/list_notice.php">
                        <i class="fa-solid fa-flag-checkered"></i> <span> Notice </span>
                    </a>
                </li>               
                <li>
                    <a href="' . system_url . 'view/list_holiday.php">
                        <i class="fa-solid fa-calendar-check"></i> <span> Holiday </span>
                    </a>
                </li>                            
               <li>
                    <a href="' . system_url . 'view/list-attendance.php">
                        <i class="fa fa-calendar"></i> <span> Attendance </span>
                    </a>
                </li>
                <li>
                    <a href="' . system_url . 'view/my-list-tasks.php">
                        <i class="fa fa-tasks"></i> <span> Tasks </span>
                    </a>
                </li>
                
                <li>
                    <a href="' . system_url . 'view/employee-list.php">
                        <i class="fa fa-address-card" aria-hidden="true"></i> <span> Employee </span>
                    </a>
                </li>
                <li>
                    <a href="' . system_url . 'view/admin_home.php">
